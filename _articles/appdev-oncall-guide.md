...
* Check [Manual review for IdV phone step](https://gitlab.login.gov/lg-teams/security/login-security-handbook/-/wikis/resources/Runbooks/IdV-Phone-Manual-Review) guide for instructions
