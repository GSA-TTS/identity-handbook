...
- You have [set up `aws-vault`](https://login-handbook.app.cloud.gov/articles/infrastructure-setting-up-aws-vault.html), and have can SSH (via `ssm-instance`) in to our production environment
