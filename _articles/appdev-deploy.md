...
2. Use the `/Production App Recycle` workflow in `#login-prod-changes` to announce the start of the deployment
...
1. Announce the configuration change in `#login-prod-changes`
