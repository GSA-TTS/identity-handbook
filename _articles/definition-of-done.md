...
- If removing a previously populated billing or accounting related item from the database (changing `sp_costs`):
  ...
  - Drop a line in [`#login-ops`](https://gsa-tts.slack.com/archives/GAYUZ4PV5) noting the proposed change and ensure the data is not needed for billing/reporting
  - Add a note on the discussion to the PR
  - Add a member of [`#login-ops`](https://gsa-tts.slack.com/archives/GAYUZ4PV5) as an approver and get their sign-off before proceeding
